...
public class SensorFragment extends Fragment {
    ...
    private DataPoint readData() {
        ...
        ob2 = mapCoords[4];
        ob3 = mapCoords[5];
        xobj1 = Math.sin(obj1ang)*Double.parseDouble(ob1) + Integer.parseInt(x);
        yobj1 = Math.cos(obj1ang)*Double.parseDouble(ob1) + Integer.parseInt(y);
        xobj2 = Math.sin(obj2ang)*Double.parseDouble(ob2) + Integer.parseInt(x);
        yobj2 = Math.cos(obj2ang)*Double.parseDouble(ob2) + Integer.parseInt(y);
        xobj3 = Math.sin(obj3ang)*Double.parseDouble(ob3) + Integer.parseInt(x);
        yobj3 = Math.cos(obj3ang)*Double.parseDouble(ob3) + Integer.parseInt(y);
